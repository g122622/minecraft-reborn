...
public:
     ...
     * @brief 获取天空渲染器
     */
    [[nodiscard]] SkyRenderer& skyRenderer();
    [[nodiscard]] const SkyRenderer& skyRenderer() const;
    [[nodiscard]] bool isSkyRendererInitialized() const { return m_skyRendererInitialized; }

    /**
     * @brief 获取 GUI 渲染器
     */
    [[nodiscard]] GuiRenderer& guiRenderer();
    [[nodiscard]] const GuiRenderer& guiRenderer() const;
     ...
     * @brief 获取物品渲染器
     */
    [[nodiscard]] ItemRenderer& itemRenderer();
    [[nodiscard]] const ItemRenderer& itemRenderer() const;
...
private:
    ...
    std::unique_ptr<GuiRenderer> m_guiRendererPtr;
