 ...
 * 返回 true 表示可以生成。
 */
using SpawnPositionCheck = std::function<bool(mc::server::ServerWorld&, i32 x, i32 y, i32 z, const SpawnEntry&)>;
...
private:
     ...
     * @brief 获取生成高度
     */
    [[nodiscard]] i32 getSpawnHeight(mc::server::ServerWorld& world, i32 x, i32 z) const;
};
